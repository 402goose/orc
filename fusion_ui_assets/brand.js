...
(() => {
  ...
  const members = [
    ...
    ["truffle", "Snout", "The truffle scout", "A stubborn little pig with an excellent nose. Treasure means a fix worth making.", "Scout open issues and queue the ones supported by source evidence.", "truffle"],
  ...
  window.ORCBrand = {icon, chapters, hero, guide};
