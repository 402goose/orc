...
for module in fusion_decisions fusion_laya fusion_policy fusion_build fusion_decision_cli fusion_progress fusion_report fusion_ui fusion_labeling fusion_publish fusion_learning fusion_garden fusion_quality fusion_truffle; do
